...
def save_upload_file(PostFile, FilePath):
    #print('file is %s ' % (PostFile+'/'+FilePath))
    print('postfile is %s,type is %s  ' % (str(PostFile),type(str(PostFile))))
    print('filepath is %s,type is %s ' % (FilePath,type(FilePath)))

    try:
        f = open(FilePath+'/'+str(PostFile), 'wb')
